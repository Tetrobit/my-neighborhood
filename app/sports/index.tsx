...
export default function SportOrganizationsScreen() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setOrganizations(MOCK_SPORT_ORGANIZATIONS);
      setLoading(false);
    }, 1000);
  }, []);
  ...
  const handleMapPress = (organization: SportOrganization) => {
                ...
                <View style={styles.content}>
                  ...
                  <View style={styles.statsContainer}>
                    <View style={styles.stat}>
                      <Text style={styles.statValue}>{item.sections.length}</Text>
                      <Text style={styles.statLabel}>Секций</Text>
                    </View>
